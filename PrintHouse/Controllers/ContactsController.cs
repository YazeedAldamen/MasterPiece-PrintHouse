...
namespace PrintHouse.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Name,Email,subject,message,contact_Id")] Contact contact)
        {
            if (ModelState.IsValid)
            {
                db.Contacts.Add(contact);
                db.SaveChanges();
                Session["SweetAlertMessage"] = "Your message has been sent";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Name,Email,subject,message,contact_Id")] Contact contact)
        {
            if (ModelState.IsValid)
            {
